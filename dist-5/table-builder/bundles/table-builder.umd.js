(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ngx-virtual-scroller'), require('@angular/cdk/drag-drop'), require('@angular/common'), require('rxjs/operators'), require('rxjs'), require('@angular/animations'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('@angular-ru/ng-table-builder', ['exports', '@angular/core', 'ngx-virtual-scroller', '@angular/cdk/drag-drop', '@angular/common', 'rxjs/operators', 'rxjs', '@angular/animations', '@angular/platform-browser'], factory) :
    (global = global || self, factory((global['angular-ru'] = global['angular-ru'] || {}, global['angular-ru']['ng-table-builder'] = {}), global.ng.core, global.ngxVirtualScroller, global.ng.cdk['drag-drop'], global.ng.common, global.rxjs.operators, global.rxjs, global.ng.animations, global.ng.platformBrowser));
}(this, function (exports, core, ngxVirtualScroller, dragDrop, common, operators, rxjs, animations, platformBrowser) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    /** @type {?} */
    var NGX_TABLE_OPTIONS = new core.InjectionToken('NGX_TABLE_OPTIONS');
    ...
    var NgxContextMenuComponent = /** @class */ (function (_super) {
        ...
        NgxContextMenuComponent.propDecorators = {
            ...
            targetElement: [{ type: core.ViewChild, args: ['targetElement', { static: false },] }]
        };
    ...
    var ColumnOptions = /** @class */ (function () {
        ...
        ColumnOptions.propDecorators = {
            ...
            filterType: [{ type: core.Input, args: ['filter-type',] }],
            cssClass: [{ type: core.Input, args: ['css-class',] }],
            cssStyle: [{ type: core.Input, args: ['css-style',] }]
        };
    ...
    var TemplateCellCommon = /** @class */ (function () {
        ...
        TemplateCellCommon.propDecorators = {
            ...
            width: [{ type: core.Input }],
            height: [{ type: core.Input }],
            cssStyles: [{ type: core.Input, args: ['ng-style',] }],
            cssClasses: [{ type: core.Input, args: ['ng-class',] }],
    ...
    var TemplateHeadThDirective = /** @class */ (function (_super) {
        ...
        TemplateHeadThDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'ng-template[ngx-th]' },] }
        ];
        /** @nocollapse */
        ...
        TemplateHeadThDirective.propDecorators = {
            type: [{ type: core.Input, args: ['ngx-th',] }]
        };
    ...
    var TemplateBodyTdDirective = /** @class */ (function (_super) {
        ...
        TemplateBodyTdDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'ng-template[ngx-td]' },] }
        ];
        /** @nocollapse */
        ...
        TemplateBodyTdDirective.propDecorators = {
            type: [{ type: core.Input, args: ['ngx-td',] }]
        };
    ...
    var NgxColumnComponent = /** @class */ (function (_super) {
        ...
        NgxColumnComponent.propDecorators = {
            key: [{ type: core.Input }],
            stickyLeft: [{ type: core.Input, args: ['sticky',] }],
            emptyHead: [{ type: core.Input, args: ['empty-head',] }],
            headTitle: [{ type: core.Input, args: ['head-title',] }],
            customKey: [{ type: core.Input, args: ['custom-key',] }],
            importantTemplate: [{ type: core.Input, args: ['important-template',] }],
            stickyRight: [{ type: core.Input, args: ['sticky-end',] }],
            verticalLine: [{ type: core.Input, args: ['vertical-line',] }],
            th: [{ type: core.ContentChild, args: [TemplateHeadThDirective, { static: false },] }],
            td: [{ type: core.ContentChild, args: [TemplateBodyTdDirective, { static: false },] }]
        };
    ...
    var TableContent = /** @class */ (function () {
        ...
        TableContent.propDecorators = {
            height: [{ type: core.Input }],
            contentCell: [{ type: core.Input, args: ['content-cell',] }],
            alignCenter: [{ type: core.Input, args: ['align-center',] }],
            cssClasses: [{ type: core.Input, args: ['css-class',] }],
            bold: [{ type: core.Input }]
        };
        return TableContent;
    }());
    ...
    var FilterableService = /** @class */ (function () {
        function FilterableService(thread, utils, ngZone, app) {
            ...
            this.filterOpenEvents = new rxjs.Subject();
            this.events = new rxjs.ReplaySubject();
    ...
    var NgxFilterDirective = /** @class */ (function () {
        ...
        NgxFilterDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'ng-template[ngx-filter]' },] }
        ];
        /** @nocollapse */
        ...
        NgxFilterDirective.propDecorators = {
            type: [{ type: core.Input, args: ['ngx-filter',] }]
        };
    ...
    var NgxFilterComponent = /** @class */ (function (_super) {
        ...
        NgxFilterComponent.propDecorators = {
            ...
            height: [{ type: core.Input }],
            maxHeight: [{ type: core.Input, args: ['max-height',] }],
            filter: [{ type: core.ContentChild, args: [NgxFilterDirective, { static: false },] }],
            targetElement: [{ type: core.ViewChild, args: ['targetElement', { static: false },] }]
        };
    ...
    var TableBuilderApiImpl = /** @class */ (function () {
        function TableBuilderApiImpl() {
            ...
            this.schemaColumns = [];
            this.afterRendered = new core.EventEmitter();
            this.schemaChanges = new core.EventEmitter();
        ...
        TableBuilderApiImpl.propDecorators = {
            ...
            sortTypes: [{ type: core.Input, args: ['sort-types',] }],
            excludeKeys: [{ type: core.Input, args: ['exclude-keys',] }],
            autoWidth: [{ type: core.Input, args: ['auto-width',] }],
            autoHeightDetect: [{ type: core.Input, args: ['auto-height',] }],
            nativeScrollbar: [{ type: core.Input, args: ['native-scrollbar',] }],
            primaryKey: [{ type: core.Input, args: ['primary-key',] }],
            columnWidth: [{ type: core.Input, args: ['column-width',] }],
            rowHeight: [{ type: core.Input, args: ['row-height',] }],
            asyncColumns: [{ type: core.Input, args: ['async-columns',] }],
            verticalBorder: [{ type: core.Input, args: ['vertical-border',] }],
            enableSelection: [{ type: core.Input, args: ['enable-selection',] }],
            enableFiltering: [{ type: core.Input, args: ['enable-filtering',] }],
            bufferAmount: [{ type: core.Input, args: ['buffer-amount',] }],
            schemaColumns: [{ type: core.Input, args: ['schema-columns',] }],
            afterRendered: [{ type: core.Output }],
            schemaChanges: [{ type: core.Output }],
            columnOptions: [{ type: core.ContentChild, args: [NgxOptionsComponent, { static: false },] }],
            columnTemplates: [{ type: core.ContentChildren, args: [NgxColumnComponent,] }],
            contextMenuTemplate: [{ type: core.ContentChild, args: [NgxContextMenuComponent, { static: false },] }],
            headerTemplate: [{ type: core.ContentChild, args: [NgxHeaderComponent, { static: false },] }],
            footerTemplate: [{ type: core.ContentChild, args: [NgxFooterComponent, { static: false },] }],
            filterTemplate: [{ type: core.ContentChild, args: [NgxFilterComponent, { static: false },] }]
        };
    ...
    /** @type {?} */
    var NGX_ANIMATION = animations.trigger('fadeAnimation', [
        // the "in" style determines the "resting" state of the element when it is visible.
        animations.state('in', animations.style({ opacity: 1 })),
        // fade in when created. this could also be written as transition('void => *')
        animations.transition(':enter', [animations.style({ opacity: 0 }), animations.animate(DEFAULT_TIME_ANIMATION)]),
        // fade out when destroyed. this could also be written as transition('void => *')
        animations.transition(':leave', animations.animate(DEFAULT_TIME_ANIMATION, animations.style({ opacity: 0 })))
    ]);
    ...
    var DraggableService = /** @class */ (function () {
        ...
        function (previousKey, currentKey) {
            ...
            if (this.canDropped(previousIndex, currentIndex)) {
                ...
                dragDrop.moveItemInArray(this.columns, previousIndex, currentIndex);
            }
        };
        /**
         * @param {?} previousIndex
    ...
    var NgxTableViewChangesService = /** @class */ (function () {
        ...
        /** @nocollapse */ NgxTableViewChangesService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function NgxTableViewChangesService_Factory() { return new NgxTableViewChangesService(); }, token: NgxTableViewChangesService, providedIn: "root" });
    ...
    var OverloadScrollService = /** @class */ (function () {
        function OverloadScrollService() {
            this.scrollStatus = new rxjs.Subject();
        }
    ...
    var TableBuilderComponent = /** @class */ (function (_super) {
        ...
        function () {
            var _this = this;
            this.overloadScroll.scrollStatus.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} scrolling
             * @return {?}
             */
            function (scrolling) {
        ...
        function () {
            var _this = this;
            if (this.enableSelection) {
                this.selection.onChanges.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
                 * @return {?}
                 */
                function () {
                    _this.detectChanges();
        ...
        function () {
            ...
            if (this.columnTemplates) {
                this.columnTemplates.changes.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
                 * @return {?}
                 */
                function () {
                    _this.markForCheck();
            ...
            if (this.contextMenuTemplate) {
                this.contextMenu.events.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
                 * @return {?}
                 */
                function () { return _this.detectChanges(); }));
            }
        ...
        TableBuilderComponent.propDecorators = {
            headerRef: [{ type: core.ViewChild, args: ['header', { static: false },] }],
            footerRef: [{ type: core.ViewChild, args: ['footer', { static: false },] }]
        };
    ...
    var WheelThrottlingDirective = /** @class */ (function () {
        function WheelThrottlingDirective(options, ngZone, overload) {
            ...
            this.scrollOffset = new core.EventEmitter();
        ...
        function () {
            var _this = this;
            this.subscription = rxjs.fromEvent(this.element, 'wheel').subscribe((/**
             * @param {?} event
             * @return {?}
             */
            function (event) {
        ...
        WheelThrottlingDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[wheelThrottling]' },] }
        ];
        /** @nocollapse */
        WheelThrottlingDirective.ctorParameters = function () { return [
            { type: TableBuilderOptionsImpl, decorators: [{ type: core.Inject, args: [NGX_TABLE_OPTIONS,] }] },
            { type: core.NgZone },
            { type: OverloadScrollService }
        ]; };
        WheelThrottlingDirective.propDecorators = {
            wheelThrottling: [{ type: core.Input }],
            scrollOffset: [{ type: core.Output }]
        };
    ...
    var TableLineRow = /** @class */ (function () {
        ...
        TableLineRow.propDecorators = {
            isRendered: [{ type: core.Input, args: ['is-rendered',] }],
            columnIndex: [{ type: core.Input, args: ['column-index',] }],
            clientRowHeight: [{ type: core.Input, args: ['client-row-height',] }],
            columnSchema: [{ type: core.Input, args: ['column-schema',] }]
        };
        return TableLineRow;
    }());
    ...
    var TableTheadComponent = /** @class */ (function (_super) {
        ...
        function TableTheadComponent(selection, utils, filterable) {
            ...
            _this.sortByKey = new core.EventEmitter();
        ...
        TableTheadComponent.propDecorators = {
            headerTop: [{ type: core.Input, args: ['header-top',] }],
            sortableDefinition: [{ type: core.Input, args: ['sortable-definition',] }],
            filterableDefinition: [{ type: core.Input, args: ['filterable-definition',] }],
            resize: [{ type: core.Output }],
            sortByKey: [{ type: core.Output }]
        };
    ...
    var TableTbodyComponent = /** @class */ (function (_super) {
        ...
        function () {
             ...
             * @return {?}
             */
            function (scrolling) { return !scrolling; })), operators.takeUntil(this.destroy$))
                .subscribe((/**
             * @return {?}
             */
        ...
        TableTbodyComponent.propDecorators = {
            source: [{ type: core.Input }],
            striped: [{ type: core.Input }],
            isFirefox: [{ type: core.Input, args: ['is-firefox',] }],
            recalculated: [{ type: core.Input }],
            primaryKey: [{ type: core.Input, args: ['primary-key',] }],
            selectionEntries: [{ type: core.Input, args: ['selection-entries',] }],
            contextMenuTemplate: [{ type: core.Input, args: ['context-menu',] }],
            enableSelection: [{ type: core.Input, args: ['enable-selection',] }],
            tableViewport: [{ type: core.Input, args: ['table-viewport',] }],
            columnVirtualHeight: [{ type: core.Input, args: ['column-virtual-height',] }],
            showedCellByDefault: [{ type: core.Input, args: ['showed-cell-by-default',] }],
            bufferAmount: [{ type: core.Input, args: ['buffer-amount',] }],
            scroll: [{ type: core.ViewChild, args: ['scroll', { static: true },] }]
        };
    ...
    var AutoHeightDirective = /** @class */ (function () {
        function AutoHeightDirective(element, ngZone) {
            ...
            this.footerHeight = 0;
            this.autoHeight = {};
            this.recalculatedHeight = new core.EventEmitter();
        ...
        AutoHeightDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[autoHeight]' },] }
        ];
        /** @nocollapse */
        ...
        AutoHeightDirective.propDecorators = {
            ...
            recalculatedHeight: [{ type: core.Output }]
        };
    ...
    var DeepPathPipe = /** @class */ (function () {
        ...
        DeepPathPipe.decorators = [
            { type: core.Pipe, args: [{ name: 'deepPath', pure: true },] }
        ];
        return DeepPathPipe;
    }());
    ...
    var DefaultValuePipe = /** @class */ (function () {
        ...
        DefaultValuePipe.decorators = [
            { type: core.Pipe, args: [{ name: 'defaultValue', pure: true },] }
        ];
    ...
    var TableCellComponent = /** @class */ (function (_super) {
        ...
        TableCellComponent.propDecorators = {
            ...
            isFilterable: [{ type: core.Input, args: ['is-filterable',] }]
        };
    ...
    var ObserverViewDirective = /** @class */ (function () {
        function ObserverViewDirective(element, ngZone) {
            this.element = element;
            this.ngZone = ngZone;
            this.observeVisible = new core.EventEmitter();
            this.observer = null;
        ...
        ObserverViewDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[observerView]' },] }
        ];
        /** @nocollapse */
        ...
        ObserverViewDirective.propDecorators = {
            observeVisible: [{ type: core.Output }],
            isRendered: [{ type: core.Input, args: ['rendered',] }]
        };
    ...
    var NgxContextMenuItemComponent = /** @class */ (function () {
        ...
        NgxContextMenuItemComponent.propDecorators = {
            ...
            contextTitle: [{ type: core.Input }],
            disable: [{ type: core.Input }],
            divider: [{ type: core.Input }],
            disableSubMenu: [{ type: core.Input, args: ['disable-sub-menu',] }],
            subMenuWidth: [{ type: core.Input, args: ['sub-menu-width',] }],
            onClick: [{ type: core.Output }],
            itemRef: [{ type: core.ViewChild, args: ['item', { static: false },] }]
        };
    ...
    var NgxMenuContentComponent = /** @class */ (function () {
        ...
        NgxMenuContentComponent.propDecorators = {
            ...
            noMargin: [{ type: core.Input, args: ['no-margin',] }],
            alignCenter: [{ type: core.Input, args: ['align-center',] }],
    ...
    var OverflowTooltipDirective = /** @class */ (function () {
        ...
        function () {
            var _this = this;
            rxjs.fromEvent(this.element, 'mouseenter')
                .pipe(operators.takeUntil(this.destroy$))
                .subscribe((/**
             * @return {?}
             */
            function () { return _this.detectCheckOverflow(); }));
            rxjs.fromEvent(this.element, 'mouseleave')
                .pipe(operators.takeUntil(this.destroy$))
                .subscribe((/**
             * @return {?}
             */
            ...
            function () {
                ...
                function () {
                    if (_this.overflowContentElem) {
                        ...
                        rxjs.fromEvent(_this.overflowContentElem, 'mouseleave')
        ...
        OverflowTooltipDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[overflowTooltip]' },] }
        ];
        /** @nocollapse */
        ...
        OverflowTooltipDirective.propDecorators = {
            element: [{ type: core.Input, args: ['overflowTooltip',] }],
            parent: [{ type: core.Input, args: ['parent',] }],
            textCenter: [{ type: core.Input, args: ['text-center',] }]
        };
    ...
    var TableBuilderModule = /** @class */ (function () {
        ...
        TableBuilderModule.ROOT_OPTIONS = new core.InjectionToken('NGX_TABLE_OPTIONS');
        TableBuilderModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, ngxVirtualScroller.VirtualScrollerModule, dragDrop.DragDropModule],
                        declarations: [
    ...
    exports.ImplicitContext = ImplicitContext;
    exports.NgxColumnComponent = NgxColumnComponent;
    exports.NgxTableViewChangesService = NgxTableViewChangesService;
    exports.TableBuilderComponent = TableBuilderComponent;
    exports.TableBuilderModule = TableBuilderModule;
    exports.TableFilterType = TableFilterType;
    exports.shallowUpdateRow = shallowUpdateRow;
    exports.ɵa = TableBuilderApiImpl;
    exports.ɵb = NgxOptionsComponent;
    exports.ɵba = NGX_TABLE_OPTIONS;
    exports.ɵbb = TableBuilderOptionsImpl;
    exports.ɵbc = AutoHeightDirective;
    exports.ɵbd = TableTheadComponent;
    exports.ɵbe = TableLineRow;
    exports.ɵbf = TableTbodyComponent;
    exports.ɵbg = DeepPathPipe;
    exports.ɵbh = DefaultValuePipe;
    exports.ɵbi = TableCellComponent;
    exports.ɵbj = ObserverViewDirective;
    exports.ɵbk = NgxContextMenuItemComponent;
    exports.ɵbl = NgxContextMenuDividerComponent;
    exports.ɵbm = NgxMenuContentComponent;
    exports.ɵbn = NgxEmptyComponent;
    exports.ɵbo = NgxFilterViewerComponent;
    exports.ɵbp = DragIconComponent;
    exports.ɵbq = NgxSourceNullComponent;
    exports.ɵbr = OverflowTooltipDirective;
    exports.ɵc = ColumnOptions;
    exports.ɵd = TemplateHeadThDirective;
    exports.ɵe = TemplateCellCommon;
    exports.ɵf = TemplateBodyTdDirective;
    exports.ɵg = NgxContextMenuComponent;
    exports.ɵh = ModalViewLayer;
    exports.ɵi = UtilsService;
    exports.ɵj = checkValueIsEmpty;
    exports.ɵk = ContextMenuService;
    exports.ɵl = NgxHeaderComponent;
    exports.ɵm = TableContent;
    exports.ɵn = NgxFooterComponent;
    exports.ɵo = NgxFilterComponent;
    exports.ɵp = NgxFilterDirective;
    exports.ɵq = FilterableService;
    exports.ɵr = WebWorkerThreadService;
    exports.ɵs = TemplateParserService;
    exports.ɵt = SortableService;
    exports.ɵu = SelectionService;
    exports.ɵv = ResizableService;
    exports.ɵw = DraggableService;
    exports.ɵx = OverloadScrollService;
    exports.ɵy = NGX_ANIMATION;
    exports.ɵz = WheelThrottlingDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=table-builder.umd.js.map
